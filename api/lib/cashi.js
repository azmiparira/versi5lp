...
// PAYMENT_CHANNELS — PASTIKAN QRIS pakai 'QRIS_CUSTOM', BUKAN 'Ya'!
...
// Mapping dari frontend key ke kode_channel Cashi
const CHANNEL_MAP = {
  'COD': null,
  'QRIS': 'QRIS_CUSTOM',
  'MANDIRI': 'MANDIRI',
...
function getChannelConfig(channelKey) {
  return PAYMENT_CHANNELS[channelKey] || null;
}

function resolveKodeChannel(channelKey) {
  return CHANNEL_MAP[channelKey] || null;
}
